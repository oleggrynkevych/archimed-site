...
function SyringeColors3D (props) {
    const group = useRef();
    const pivot = useRef();
    ...
    const loadModel = () => {
        ...
        loader.load(third3d, function (gltf) {
            ...
            obj.children[0].rotation.x = Math.PI * -1.65; 
    ...
    return (
      <group position={[startPositionX, startPositionY, startPositionZ]} rotation={[startRotationX, startRotationY, startRotationZ]} ref={group} {...props} dispose={null} scale={[0.22, 0.22, 0.22]}>
...
export default SyringeColors3D;